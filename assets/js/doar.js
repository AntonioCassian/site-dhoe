fetch('../../assets/json/campanhas.json')
  ...
  const elements = (json) => {
        ...
        const card= document.createElement('div');
          ...
          a.setAttribute("href", `./saibaMais.html?id=${inf.id}`)
        ...
        const cards = document.querySelector('.campanhas');
    ...
    const elementsMais = (json) => {
      const imgMais = document.querySelector('.img-tit');
      console.log(imgMais);
